...
func main() {
	...
	// e.GET("/api/v1/cct-turtle/status/:id", cct_turtle.GetTurtleStatus)
	e.GET("/api/v1/cct-turtle/forward", cct_turtle.MoveTurtleForward)
	e.GET("/api/v1/cct-turtle/forward/:id", cct_turtle.MoveTurtleForward)
	e.GET("/api/v1/cct-turtle/back", cct_turtle.MoveTurtleBackward)
	e.GET("/api/v1/cct-turtle/back/:id", cct_turtle.MoveTurtleBackward)
	e.GET("/api/v1/cct-turtle/up", cct_turtle.MoveTurtleUp)
	e.GET("/api/v1/cct-turtle/up/:id", cct_turtle.MoveTurtleUp)
	e.GET("/api/v1/cct-turtle/down", cct_turtle.MoveTurtleDown)
	e.GET("/api/v1/cct-turtle/down/:id", cct_turtle.MoveTurtleDown)
	e.GET("/api/v1/cct-turtle/left", cct_turtle.TurnTurtleLeft)
	e.GET("/api/v1/cct-turtle/left/:id", cct_turtle.TurnTurtleLeft)
	e.GET("/api/v1/cct-turtle/right", cct_turtle.TurnTurtleRight)
	e.GET("/api/v1/cct-turtle/right/:id", cct_turtle.TurnTurtleRight)
	e.GET("/api/v1/cct-turtle/dig", cct_turtle.DigTurtle)
	e.GET("/api/v1/cct-turtle/dig/:id", cct_turtle.DigTurtle)
	e.GET("/api/v1/cct-turtle/dig-up", cct_turtle.DigTurtleUp)
	e.GET("/api/v1/cct-turtle/dig-up/:id", cct_turtle.DigTurtleUp)
	e.GET("/api/v1/cct-turtle/dig-down", cct_turtle.DigTurtleDown)
	e.GET("/api/v1/cct-turtle/dig-down/:id", cct_turtle.DigTurtleDown)
